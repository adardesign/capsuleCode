    ...
    <>
      ...
      <Editor
        ...
        init={{
          ...
          menubar: true,
          plugins: [
            "link image addWidget example save",
          ...
          toolbar:
            "addWidget example save pagebreak insertfile undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image | export",
        }}
        value={contentEditor}
